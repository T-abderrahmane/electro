...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'nav.electricians': 'Électriciens',
    'nav.subscriptions': 'Abonnements',
    'nav.requests': 'Demandes',
    'nav.analytics': 'Statistiques',
    'sidebar.title': 'Panneau admin',
    'sidebar.subtitle': 'Services électriques',
    'sidebar.loggedInAs': 'Connecté en tant que',
    ...
    'login.checking': 'Vérification de session...',
    ...
    'page.users.subtitle': 'Afficher et gérer tous les utilisateurs',
    'page.electricians.title': 'Vérification des électriciens',
    'page.electricians.subtitle': 'Afficher et gérer les comptes électriciens',
    'page.subscriptions.title': 'Gestion des abonnements',
    'page.subscriptions.subtitle': 'Vérifier les paiements et activer les abonnements',
    'page.requests.title': 'Gestion des demandes',
    'page.requests.subtitle': 'Afficher et gérer les demandes de service',
